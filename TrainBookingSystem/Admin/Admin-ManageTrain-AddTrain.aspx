<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin-ManageTrain-AddTrain.aspx.cs" Inherits="TrainBookingSystem.Admin.Admin_ManageTrain_AddTrain" %>
    ...
    <form id="form1" runat="server">
        <div class="container" style="margin-top:10%;margin-bottom:10%">
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">ManageTrain-Add</div>
                    </div>
                </div>
            </div>
            <div class="row">
